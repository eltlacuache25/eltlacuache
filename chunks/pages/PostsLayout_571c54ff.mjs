...
const $$PostsLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const img = "/eltlacuache.jpg", url = "https://www.facebook.com/TlacuacheNoticias?mibextid=JRoKGi", nombre = "El Tlacuache";
  const { frontmatter } = Astro2.props;
  const { titulo, imagen, descripcion, link } = frontmatter;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Navbar", $$Navbar, { "imagen": img, "link": "/", "nombre": nombre }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "NavOption", $$NavOption, { "link": "/eltlacuache/", "nombre": "Inicio" })}${renderComponent($$result3, "NavOption", $$NavOption, { "link": "/eltlacuache/galeria", "nombre": "Galeria" })}` })}${renderComponent($$result2, "Menu", $$Menu, {}, { "default": ($$result3) => renderTemplate`${maybeRenderHead()}<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased"><div class="flex justify-between px-4 mx-auto max-w-screen-xl "><article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert"><header class="mb-4 lg:mb-6 not-format"><h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">${titulo}</h1></header><figure class="mb-4"><img${addAttribute(imagen, "src")} class="mx-auto w-full lg:max-w-xl h-full w-full rounded-lg shadow-x" alt=""></figure><p class="lead">${descripcion}</p><div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 mt-4"><a${addAttribute(link, "href")} target="_blank" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
Ver en facebook
